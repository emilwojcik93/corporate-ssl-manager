...
function Test-ConfigurationSummary {
    ...
    try {
        ...
        if ($dockerCorpExists -eq "exists") {
            ...
            if ($googleSuccess) {
                Write-ColorLog "docker-corp google.com: ✅ HTTP $googleStatus" -Level "SUCCESS" -Color Green
            } else {
                Write-ColorLog "docker-corp google.com: ❌ HTTP $googleStatus" -Level "ERROR" -Color Red
            }
            
            if ($githubSuccess) {
                Write-ColorLog "docker-corp github.com: ✅ HTTP $githubStatus" -Level "SUCCESS" -Color Green
            } else {
                Write-ColorLog "docker-corp github.com: ❌ HTTP $githubStatus" -Level "ERROR" -Color Red
            }
